...
// If the receiver is fixed by GPS, GLONASS and Galileo,
// it will print GPGGA, GNGSA, GPGSV, GLGSV, GAGSV, GNRMC, GPVTG and GNGLL
const char NmeaDataTypeGPGGA[] = "GPGGA";
const char NmeaDataTypeGPRMC[] = "GPRMC";
const char NmeaDataTypeGNRMC[] = "GNRMC";
const char NmeaDataTypeGLRMC[] = "GLRMC";
...
int GPS::ParseGPSData(int idx)
{
    ...
    else if (strncmp((const char *)NmeaGpsData.NmeaDataType, (const char *)NmeaDataTypeGPRMC, 5) == 0 || strncmp((const char *)NmeaGpsData.NmeaDataType, (const char *)NmeaDataTypeGNRMC, 5) == 0 || strncmp((const char *)NmeaGpsData.NmeaDataType, (const char *)NmeaDataTypeGLRMC, 5) == 0)
    {
        // NmeaUtcTime
        fieldSize = 0;
        while (NmeaString[i + fieldSize++] != ',')
